...
export const TRUSTED_SOURCES: TrustedSource[] = [
  ...
  // Regional — Canada
  { domain: 'cbc.ca',                       name: 'CBC News',                   group: 'Regional' },
  { domain: 'globeandmail.com',             name: 'The Globe and Mail',         group: 'Regional' },
  { domain: 'nationalpost.com',             name: 'National Post',              group: 'Regional' },
  { domain: 'thestar.com',                  name: 'Toronto Star',               group: 'Regional' },
  // Regional — New Zealand & Ireland
  { domain: 'rnz.co.nz',                    name: 'Radio New Zealand',          group: 'Regional' },
  { domain: 'nzherald.co.nz',               name: 'NZ Herald',                  group: 'Regional' },
  { domain: 'irishtimes.com',               name: 'Irish Times',                group: 'Regional' },
  { domain: 'rte.ie',                       name: 'RTÉ News',                   group: 'Regional' },
  // Regional — Europe
  { domain: 'france24.com',                 name: 'France 24',                  group: 'Regional' },
  { domain: 'dw.com',                       name: 'Deutsche Welle',             group: 'Regional' },
  { domain: 'politico.eu',                  name: 'Politico Europe',            group: 'Regional' },
  { domain: 'thelocal.com',                 name: 'The Local Europe',           group: 'Regional' },
  { domain: 'swissinfo.ch',                 name: 'SWI swissinfo.ch',           group: 'Regional' },
  { domain: 'dutchnews.nl',                 name: 'DutchNews.nl',               group: 'Regional' },
  { domain: 'polandin.com',                 name: 'Poland In',                  group: 'Regional' },
